...
# 		population_2018 AS Population_2018,
#         population_2019 AS Population_2019,
#         population_2019 - population_2018 AS Population_difference
#  FROM country
#  WHERE population_2019 >= 1000000 AND
#  		population_2019 <= 10000000
...
# SELECT *
# FROM user
# WHERE last_name LIKE '%ov' AND
# 		city NOT IN ('Sacramento', 'San Jose');
...
# SELECT *
# FROM country
# WHERE population_2018 IS NOT NULL AND
# 	population_2019 IS NOT NULL;
